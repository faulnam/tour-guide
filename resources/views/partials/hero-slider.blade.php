                    ...
                    <div class="relative z-10 max-w-4xl mx-auto px-5 md:px-8 text-center space-y-4 pt-16">
                        ...
                        @if($slide->button_text && $slide->button_link)
                            <div class="pt-3 flex items-center justify-center gap-3">
                                <a href="{{ url($slide->button_link) }}" class="px-6 py-2.5 rounded-lg bg-accent hover:bg-accent-dark text-primary-dark hover:text-white font-bold text-xs uppercase tracking-wider transition-all shadow-md">
